          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span>nsr9602448@gmail.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="w-6 h-6 text-purple-600 mr-4" />
                <span>+91 (8209427996)</span>
              </div>
              <div className="flex items-center">
            ...
            <div className="bg-purple-50 p-6 rounded-xl">
              <h4 className="text-lg font-semibold mb-2">Let's collaborate!</h4>
              <p className="text-gray-600">
                I'm interested in AI/ML projects, research opportunities, and innovative technical challenges. Let's discuss how we can work together!
              </p>
            </div>
          </div>
